...
city_id_1 = exec_command(
    my_console, "create City state_id=\"{}\" name=\"Fremont\"".format(state_id_1))
if city_id_1 is None or city_id_1 == "":
    print("FAIL: Can't create City 1")

city_id_2 = exec_command(
    my_console, "create City state_id=\"{}\" name=\"Napa\"".format(state_id_1))
...
city_id_3 = exec_command(
    my_console, "create City state_id=\"{}\" name=\"Sonoma\"".format(state_id_2))
