#!/usr/bin/python3
# Graham S. Paul (tmp_console_main.py)
""" Console Module """
import cmd
import sys
...
class HBNBCommand(cmd.Cmd):
    """Holds the functionality for the HBNB console"""

    # Decides prompt for interactive/non-interactive modes
